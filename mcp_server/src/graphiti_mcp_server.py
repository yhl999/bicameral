...
def _build_get_tools_response() -> list[dict[str, Any]]:
    return [
        ...
        _tool_schema_entry(
            ...
            examples=[{'pack_id': 'context-vc-deal-brief', 'task': 'series a diligence'}],
            phase0_behavior='Validates pack_id/task and then materializes matching context facts.',
        ),
        _tool_schema_entry(
            ...
            inputs={'pack_id': 'string', 'task': 'string | null'},
            output='PackMaterialized | ErrorResponse',
            examples=[{'pack_id': 'workflow-deal-review', 'task': 'series a diligence'}],
            phase0_behavior='Validates pack_id/task and then materializes matching workflow facts.',
        ),
        _tool_schema_entry(
            name='describe_pack',
            ...
            phase0_behavior='Validates pack_id and then returns the registered pack definition.',
        ),
        _tool_schema_entry(
            ...
            phase0_behavior='Validates the definition and persists a new workflow pack in the user registry.',
        ),
        _tool_schema_entry(
